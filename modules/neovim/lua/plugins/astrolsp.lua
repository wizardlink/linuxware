...
return {
	...
	opts = function(_, opts)
		...
		-- HACK: LSP servers are not starting automatically in Neovim 0.11.x
		-- when vim.lsp.enable got introduced, so now I'm enabling all LSP servers
		-- that are configured. :)
		lsp_options.on_attach = function(client, bufnr)
			vim.lsp.enable(lsp_options.servers)
		end
